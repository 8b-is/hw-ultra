...
pub const REG_I2S_CTRL: usize = 0x100;
pub const REG_I2S_STATUS: usize = 0x104;
pub const REG_I2S_FORMAT: usize = 0x108;
pub const REG_I2S_RATE: usize = 0x10C;
pub const REG_CODEC_CTRL: usize = 0x200;
pub const REG_CODEC_STATUS: usize = 0x204;
pub const REG_CODEC_VOLUME: usize = 0x208;
pub const REG_DMA_CTRL: usize = 0x300;
pub const REG_DMA_ADDR: usize = 0x304;
pub const REG_DMA_LEN: usize = 0x308;
pub const REG_DMA_STATUS: usize = 0x30C;

pub const CLK_MCLK: u32 = 1 << 0;
pub const CLK_BCLK: u32 = 1 << 1;
...
pub fn enable_clocks(mmio_base: usize) {
    unsafe {
        super::super::mmio::mmio_write32(mmio_base + REG_CLK, CLK_MCLK | CLK_BCLK | CLK_AHB);
    }
}
...
pub fn set_i2s_format(mmio_base: usize, format: u32) {
    unsafe {
        super::super::mmio::mmio_write32(mmio_base + REG_I2S_FORMAT, format);
    }
}

pub fn set_sample_rate(mmio_base: usize, rate: u32) {
    unsafe {
        super::super::mmio::mmio_write32(mmio_base + REG_I2S_RATE, rate);
    }
}

pub fn set_codec_volume(mmio_base: usize, volume: u32) {
    unsafe {
        super::super::mmio::mmio_write32(mmio_base + REG_CODEC_VOLUME, volume);
    }
}
